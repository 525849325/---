...
namespace ImmortalLoot.Network
{
    ...
    [Serializable] public sealed class RealmBreakthroughDto { public string realmId; public int realmStage; public bool succeeded; public string spiritualRootId; public bool replayed; }
    ...
    [Serializable] public sealed class BattleFinishDto { public string sessionId; public string status; public long rewardSoftCurrency; public long rewardExp; public string equipmentInstanceId; public bool replayed; }
