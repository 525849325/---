...
- **结果：** EditMode 109/109、PlayMode 26/26、最新代码对应 APK 与 AAB 构建全部 exit 0；日志确认成功连接 IPC 并解析 entitlement。batch 没有 Hub access token 用于在线刷新，但本地 entitlement 可正常解析，不构成失败。
