...
$sources = @(
    ...
    (Join-Path $projectRoot 'Assets\Game\Scripts\Core\IServerClock.cs'),
    ...
    (Join-Path $projectRoot 'Assets\Game\Scripts\Character\CharacterStatAggregator.cs'),
    (Join-Path $projectRoot 'Assets\Game\Scripts\Character\CharacterStatService.cs'),
    (Join-Path $projectRoot 'Assets\Game\Scripts\Realm\RealmProgressionService.cs'),
